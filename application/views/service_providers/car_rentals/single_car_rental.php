        ...
        <div class="row-fluid margin-bottom-30">
            ...
            <div class="span5 front-carousel">
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                             <img src="<?php echo base_url(); ?><?= $row->cr_image2 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
                        <div class="item">
                            <img src="<?php echo base_url(); ?><?= $row->cr_image3 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
                         ...
                         <div class="item">
                            <img src="<?php echo base_url(); ?><?= $row->cr_image4 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
                         ...
                         <div class="item">
                            <img src="<?php echo base_url(); ?><?= $row->cr_image5 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
                         ...
                         <div class="item">
                            <img src="<?php echo base_url(); ?><?= $row->cr_image6 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
                         ...
                         <div class="item">
                            <img src="<?php echo base_url(); ?><?= $row->cr_image7 ?>">
                            <div class="carousel-caption">
                                <p><?= $row->cr_name ?></p>
                            </div>
                        </div>
            ...
            <div class="span7">
                ...
                <div class="row-fluid front-lists-v2 margin-bottom-15">
                    ...
                    <div class="span6">
                        <ul class="unstyled">
                            <li><i class="icon-compass"></i> <?= $row->cr_location ?></li>
