<?php $counter = 0; $number_of_inputs = count($club_location); ?> 
...
<?php if($counter%4 == 0) echo '<div class="contaner">'; ?> 
                                        ...
                                        <div class="span3 pricing pricing-active">
                                            ...
                                            <ul class="pricing-content unstyled">
                                                ...
                                                <li><i class=" icon-compass"></i> <?= $row->club_location ?>&nbsp;, &nbsp;<?= $row->club_city ?></li>
                                            ...
                                            <div class="pricing-footer">
                                                ...
                                                <a href=<?php echo site_url('clubs/reservation/' . $row->club_id) ?> class="btn green">Reserve <i class="m-icon-swapright m-icon-white"></i></a>
